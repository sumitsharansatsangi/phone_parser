  ...
  for (final territory in territoryIterable) {
    try {
      ...
      if (territory.getAttribute("internationalPrefix") != null) {
        territoryDict["internationalPrefix"] = territory.getAttribute(
          "internationalPrefix",
        );
      ...
      if (territory.getAttribute("preferredExtnPrefix") != null) {
        territoryDict["preferredExtnPrefix"] = territory.getAttribute(
          "preferredExtnPrefix",
        );
      ...
      if (territory.getAttribute("mainCountryForCode") != null) {
        territoryDict["mainCountryForCode"] = territory.getAttribute(
          "mainCountryForCode",
        );
      ...
      if (territory.getAttribute("preferredInternationalPrefix") != null) {
        territoryDict["preferredInternationalPrefix"] = territory.getAttribute(
      ...
      Iterable<XmlElement> availableFormats = territory.findAllElements(
        "availableFormats",
      );
      ...
      if (availableFormats.isNotEmpty) {
        ...
        for (final availableFormat in availableFormats) {
          Iterable<XmlElement> numberFormats = availableFormat.findAllElements(
            "numberFormat",
          );
          ...
          if (numberFormats.isNotEmpty) {
            for (final numberFormat in numberFormats) {
              ...
              if (numberFormat.getAttribute("pattern") != null) {
                numberFormatDict["pattern"] = numberFormat.getAttribute(
                  "pattern",
                );
              }
              if (numberFormat.getAttribute("nationalPrefixFormattingRule") !=
                  null) {
                numberFormatDict["nationalPrefixFormattingRule"] = numberFormat
                    .getAttribute("nationalPrefixFormattingRule");
              } else if (numberFormat.getAttribute(
              ...
              if (numberFormat.getAttribute("carrierCodeFormattingRule") !=
                  null) {
                numberFormatDict["carrierCodeFormattingRule"] = numberFormat
              ...
              Iterable<XmlElement> leadingDigits = numberFormat.findAllElements(
                "leadingDigits",
              );
              ...
              if (leadingDigits.length == 1) {
                ...
                for (final leadingDigit in leadingDigits) {
                  leadingDigitList.add(
                    leadingDigit.innerText.replaceCarriages(),
                  );
                }
                numberFormatDict["leadingDigits"] = leadingDigitList;
              }
              Iterable<XmlElement> format = numberFormat.findAllElements(
                "format",
              );
              if (format.length == 1) {
              ...
              Iterable<XmlElement> intlFormat = numberFormat.findAllElements(
                "intlFormat",
              );
              ...
              if (intlFormat.length == 1) {
                numberFormatDict["intlFormat"] = intlFormat
                    .elementAt(0)
                    .innerText;
      ...
      Iterable<XmlElement> generalDesc = territory.findAllElements(
        "generaldesc",
      );
      ...
      if (generalDesc.isNotEmpty) {
        ...
        if (generalDesc.length == 1) {
          Iterable<XmlElement> nationalNumberPattern = generalDesc
              .elementAt(0)
        ...
        for (final key in keyList) {
          Iterable<XmlElement> noInternationalDiallingIterable = territory
              .findElements(key);
          if (noInternationalDiallingIterable.isEmpty) {
            noInternationalDiallingIterable = territory.findAllElements(
              key.toLowerCase(),
            );
          }
          ...
          if (noInternationalDiallingIterable.isNotEmpty) {
            ...
            XmlElement noInternationalDialling = noInternationalDiallingIterable
                .elementAt(0);
            Iterable<XmlElement> possibleLengths = noInternationalDialling
                .findAllElements("possibleLengths");
            if (possibleLengths.isEmpty) {
              possibleLengths = noInternationalDialling.findAllElements(
                "possiblelengths",
              );
            }
            if (possibleLengths.isNotEmpty) {
              ...
              if (possibleLength.getAttribute("national") != null) {
                possibleLengthDict["national"] = possibleLength.getAttribute(
                  "national",
                );
              }
              if (possibleLength.getAttribute("localOnly") != null) {
                possibleLengthDict["localOnly"] = possibleLength.getAttribute(
                  "localOnly",
                );
            ...
            Iterable<XmlElement> nationalNumberPatternIterable =
                noInternationalDialling.findAllElements(
            ...
            if (nationalNumberPatternIterable.isNotEmpty) {
              final nationalNumberPattern = nationalNumberPatternIterable
                  .elementAt(0);
              noInternationalDiallingDict["nationalNumberPattern"] =
                  nationalNumberPattern.innerText.replaceCarriages();
            }
            Iterable<XmlElement> exampleNumberIterable = noInternationalDialling
                .findAllElements("exampleNumber");
            if (exampleNumberIterable.isEmpty) {
              exampleNumberIterable = noInternationalDialling.findAllElements(
                "examplenumber",
              );
            }
