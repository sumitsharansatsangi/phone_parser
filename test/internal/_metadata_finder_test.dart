  ...
  group('MetadataFinder', () {
    test('should get metadata for iso code', () {
      for (final isoCode in IsoCode.values) {
        expect(
          MetadataFinder.findMetadataForIsoCode(isoCode).isoCode,
          equals(isoCode),
        );
      }
    });
    ...
    test(
      'should get formats metadata for iso code going through references',
      () {
        expect(
          MetadataFinder.findMetadataFormatsForIsoCode(IsoCode.CA),
    ...
    test('should get metadata for country calling code', () {
      expect(
        MetadataFinder.findMetadataForCountryCode('33', '123456')?.isoCode,
        equals(IsoCode.FR),
      );
      expect(
