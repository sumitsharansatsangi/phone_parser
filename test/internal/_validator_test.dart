  ...
  group('_Validator', () {
    group('ValidateWithLength()', () {
      test('BE', () {
        ...
        expect(
          Validator.validateWithLength(IsoCode.BE, beValidMobilePhone),
          isTrue,
        );
        expect(
        ...
        // and not a general
        expect(
          Validator.validateWithLength(IsoCode.BE, beInvalidMobilePhone),
          isFalse,
        );
      });
      ...
      test('US', () {
        ...
        // valid US
        expect(Validator.validateWithLength(IsoCode.US, validUs), isTrue);
        expect(
          Validator.validateWithLength(
            IsoCode.US,
            validUs,
      ...
      test('zeroes', () {
        expect(Validator.validateWithLength(IsoCode.GB, '7000000002'), isTrue);
      });
      ...
      test('PT', () {
        ...
        expect(Validator.validateWithLength(isoCode, examples.mobile), isTrue);
    ...
    group('ValidateWithPattern()', () {
      ...
      test('CA', () {
        expect(
          Validator.validateWithPattern(IsoCode.CA, '7205754713'),
          isFalse,
        );
      ...
      test('US', () {
        ...
        expect(
          Validator.validateWithPattern(IsoCode.US, '6135550165'),
          isFalse,
        );
      });
      ...
      test('PT', () {
        final isoCode = IsoCode.PT;
        final examples = metadataExamplesByIsoCode[isoCode]!;
        expect(Validator.validateWithPattern(isoCode, examples.mobile), isTrue);
