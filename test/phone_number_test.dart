...
void main() {
  group('PhoneNumber', () {
    group('parsing', () {
      ...
      test('should parse with raw phone number', () {
        ...
        expect(
          PhoneNumber.parse('+33655570500').international,
          equals('+33655570500'),
        );
        expect(
          PhoneNumber.parse('+33967497670').international,
          equals('+33967497670'),
        );
        ...
        // no transform
        expect(
          parse('+54 9 343 555 1212').international,
    ...
    group('equality', () {
      test('two phones numbers with the same values should be equal', () {
        expect(
          PhoneNumber(isoCode: IsoCode.FR, nsn: '479999999'),
    ...
    test('validity', () {
      final gbValidLength = PhoneNumber.parse(
        '0000000000',
      ...
      final gbValidPattern = PhoneNumber.parse(
        '7111111111',
        destinationCountry: IsoCode.GB,
      );
  ...
  group('format', () {
    test('should format with the national format by default', () {
      String format(String phoneNumber) => PhoneNumber.parse(
        phoneNumber,
  ...
  group('range', () {
    ...
    test('range', () async {
      ...
      expect(
        PhoneNumberRange(zero, ninenine).expandRange().length,
        equals(100),
      );

      expect(
        PhoneNumberRange(zero, one).expandRange(),
        containsAllInOrder([zero, one]),
      );

      expect(
        PhoneNumberRange(zero, ninenine).expandRange(),
